...
const ReadAsBooks = () => {
  ...
  return storedBooks.length > 0 ? (
    ...
    <div className="container mx-auto space-y-8 flex flex-col items-center justify-center py-16 text-center">
      ...
      {/* Title */}
      <h2 className="text-2xl font-bold text-gray-700">No Read Books Yet</h2>

      {/* Message */}
      <p className="text-gray-500 mt-2 max-w-md">
        You haven't marked any books as read. Start exploring and add your
        favorite books!
      </p>
    </div>
  );
